<template>
  <div class="v-sidebar-menu"
    ...
    <slot name="header" />
    <div class="vsm--list">
      <sidebar-menu-item v-for="(item, index) in menu"
                         :key="index"
                         :item="item"
    ...
    <div v-if="isCollapsed"
      ...
      <sidebar-menu-item v-if="mobileItem"
                         :item="mobileItem"
                         :mobile-item="true"
                         :is-collapsed="isCollapsed"
                         :show-child="showChild"
      ...
      <div class="vsm--dropdown" :style="mobileItemStyle.dropdown">
        <transition name="expand"
          ...
          <div v-if="mobileItem && mobileItem.child"
               class="vsm--list">
            <sidebar-menu-item v-for="(item, index) in mobileItem.child"
                               :key="index"
                               :item="item"
                               :level="2"
                               :show-child="showChild"
...
import { animationMixin } from '../../helpers/mixin'
export default {
  name: 'SidebarMenu',
  components: {
    SidebarMenuItem
